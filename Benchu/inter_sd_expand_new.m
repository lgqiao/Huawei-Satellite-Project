function [S,D,delta_x,delta_y] = inter_sd_expand_new(x1,y1,x2,y2,t)
%INTER_SD_EXPAND_NEW: Compute the two intersections from the source node and the 
%                     two intersections from the destination node 


global T_x T_y

y1_peak = fx_peak_expand(x1,t);
x1_valley = fy_valley_expand(y1,t);
y2_peak = fx_peak_expand(x2,t);
x2_valley = fy_valley_expand(y2,t);

function boundary = boundary_expand(x1,y1,x2,y2,W,t)
%BOUNDARY_EXPAND: Calculate the boundaries of each area in a rectangle on the expanded map
...
if k_l>0
    ...
    inter_valley = inter_square_expand(xSource,ySource,xDestination,yDestination,max_x,max_y,t);
    ...
    [sy_source,flag] = symmetric_point(xSource,ySource,xDestination,yDestination,max_x,max_y,t);
    if flag==1
...
elseif k_l<0
    ...
    [duplicate_hor,duplicate_ver] = duplicate_expand(xSource,ySource,xDestination,yDestination,max_x,max_y,t);

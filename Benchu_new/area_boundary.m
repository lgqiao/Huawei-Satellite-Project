function boundary = area_boundary(x1,y1,x2,y2,W,t)
...
if k_l>0
    ...
    inter_valley = inter_square_valley(xSource,ySource,xDestination,yDestination,t);
    ...
    [sy_source,flag] = symmetric_end(xSource,ySource,xDestination,yDestination,t);
    if flag==1
...
elseif k_l<0
    ...
    [duplicate_hor,duplicate_ver] = duplicate_path_end(xSource,ySource,xDestination,yDestination,t);

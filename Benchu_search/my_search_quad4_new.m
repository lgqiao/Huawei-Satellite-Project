function [Path,Min_len] = my_search_quad4_new(map,W,t)
%MY_SEARCH_QUAD4_NEW: Calculate the shortest path from a source node to other nodes in an 
%                     area the fourth quadrant direction  
